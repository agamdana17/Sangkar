        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    <div
                        class="p-4 mb-5 bg-white border rounded-lg border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                    ...
                    <div
                        class="p-4 mb-5 bg-white border rounded-lg border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live='price_range'
                                ...
                                max="2000000" min="500000"  value="500000" step="50000">
                        ...
                        @foreach ($products as $product)
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3 ">
                                <div class="border border-gray-300 dark:border-gray-700 rounded-2xl"
                                    wire:key=" {{ $product->id }}">
                                    <div class="relative rounded-t-2xl bg-gray-200">
