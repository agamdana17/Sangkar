<div>
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <section class="overflow-hidden rounded-lg bg-white py-11 font-poppins dark:bg-gray-800">
                    ...
                    <div class="w-full  mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->images[0]) }}' }">
                        <div class="sticky top-0 z-50 overflow-hidden ">
                            <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                                <img x-bind:src="mainImage" alt="" class="object-cover rounded-lg w-full lg:h-full ">
                            </div>
                                ...
                                @foreach ($product->images as $image)
                                    <div class="w-1/2 p-2 sm:w-1/4"
                                        ...
                                        <img src="{{ url('storage', $image) }}" alt="{{ $product->name }}"
                                            class="object-cover rounded-lg w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                                    </div>
                                @endforeach
